...
const CreateUserService = ({ email, password, name, queueIds = [], profile = "admin", whatsappId, tipoUsuario, tipoPlan, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield User_1.default.create({
        ...
        tipoUsuario: tipoUsuario ? tipoUsuario : null,
        tipoPlan: tipoPlan ? tipoPlan : null
