...
const CreateWhatsAppService = ({ name, status = "OPENING", queueIds = [], greetingMessage, farewellMessage, isDefault = false, userId }) => __awaiter(void 0, void 0, void 0, function* () {
