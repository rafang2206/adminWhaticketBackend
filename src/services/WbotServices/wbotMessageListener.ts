...
const wbotMessageListener = (wbot: Session): void => {
  ...
  wbot.on("message", async msg => {
    ...
    if (msg.body.length > 0 && msg.body !== "1" && msg.body !== "2" && msg.body !== "3" && bool === false) {
      ...
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido a Ventas area Hogar, pronto un agente se comunicara contigo");
    }
    else if (msg.body === "2" && pasosBot[0] === "ventas") {
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido a Ventas area Movil, pronto un agente se comunicara contigo");
    }
    else if (msg.body === "3" && pasosBot[0] === "ventas") {
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido a Ventas area otro, pronto un agente se comunicara contigo");
    }
    else if (msg.body === "1" && pasosBot[0] === "soporte") {
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido Soporte area Hogar, pronto un agente se comunicara contigo");
    }
    else if (msg.body === "2" && pasosBot[0] === "soporte") {
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido Soporte area Movil, pronto un agente se comunicara contigo");
    }
    else if (msg.body === "3" && pasosBot[0] === "soporte") {
      pasosBot = [];
      wbot.sendMessage(msg.from, "Hola Bienvenido a Ventas area Otro, pronto un agente se comunicara contigo");
    }
    handleMessage(msg, wbot);
